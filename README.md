...
- #### ***Here I used IFS Function to analyze the Business transaction category with the unit sold for all stores***.
...
- #### ***Here the LOOKUP Function was used to get salary payment for all staff based on their Grade level using the simply salary structure***.
...
- #### ***Here I got the Top five(5) market based on Revenue and the Bottom five(5) stores based on the unit sold***.
...
- #### ***Here the total Revenue for each year was analyzed***
...
- #### ***created a table for employees in an organisation***.
